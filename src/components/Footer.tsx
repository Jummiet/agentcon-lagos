    ...
    <footer className="border-t border-gray-subtle mt-auto">
      <div className="container py-8 sm:py-10 text-xs sm:text-sm text-gray-light">
        <div className="flex flex-col items-center gap-4 mb-8">
          <p className="text-center max-w-2xl leading-relaxed font-semibold text-brand-blue">The Age of Agents: From Code to Cognition</p>
          <p className="text-center max-w-2xl leading-relaxed">Proudly organized by the Global AI Community - Lagos, Nigeria Chapter</p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-3 items-center gap-3 border-t border-gray-subtle pt-6">
          <p className="text-center sm:text-left">&copy; {new Date().getFullYear()} AgentCamp 2026. All rights reserved.</p>
          <p className="text-center">
            <a href="https://sessionize.com/" className="sessionize-link">
              <strong>Call for Speakers</strong> powered by <strong className="sessionize-brand">Sessionize.com</strong>
            </a>
          </p>
